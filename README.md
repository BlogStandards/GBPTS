...
<ruby>通用博文标签标准<rp>(</rp><rt>General Blog Post Tag Standard</rt><rp>)</rp></ruby>是由 Save The Web Project 提出的开放标准。
...
Telegram 的频道分类比较成熟，所以直接照搬了其分类，有少量调整。然后合并了 [ooh.directory](https://ooh.directory/) 的博客分类。分类作为内容属性标签的一级标签，其下还可以有很多可以描述具体内容的二级标签。
